...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="LemonTree.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="LemonTree1.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="LemonTree3.jpg" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
      </div>
      <div class="buttons">
        <a href="#slide-1"></a>
        <a href="#slide-2"></a>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.2659679148524!2d73.9058364144297!3d18.562044187384878!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c1193ee612bd%3A0xab053eabcb99a5f2!2sLemon%20Tree%20Hotel%2C%20Viman%20Nagar!5e0!3m2!1sen!2sin!4v1663498717519!5m2!1sen!2sin" width="650" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">LEMON TREE HOTEL </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About Lemon Tree Hotel</h1>
