...
<?php
$cookie_name="hotel";
$cookie_value="The_Orchid_Hotel_Mumbai_Vile_Parle";
...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="Orchidzz.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Orchid33.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Orchid22.webp" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
      </div>
      <div class="buttons">
        <a href="#slide-1"></a>
        <a href="#slide-2"></a>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.2395239461343!2d72.85250761744385!3d19.097145299999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c84dab4f05f3%3A0xa340672d24c78185!2sThe%20Orchid%20Hotel%20Mumbai%20Vile%20Parle!5e0!3m2!1sen!2sin!4v1666183887954!5m2!1sen!2sin" width="650" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">The Orchid Hotel Mumbai Vile Parle </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About The Orchid Hotel Mumbai Vile Parle</h1>
