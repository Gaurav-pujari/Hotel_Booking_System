...
<?php
$cookie_name="hotel";
$cookie_value="Fortune_Select_JP_Cosmos_Member_ITC_Hotel_Group";
...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="Fortune.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Fortune2.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Fortune3.webp" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
      </div>
      <div class="buttons">
        <a href="#slide-1"></a>
        <a href="#slide-2"></a>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.724367614564!2d77.59276211434556!3d12.989473190844146!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1668156cc8f1%3A0x40dfd9f6b5e94158!2sFortune%20Select%20JP%20Cosmos!5e0!3m2!1sen!2sin!4v1666175806659!5m2!1sen!2sin" width="650" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">Fortune Select JP Cosmos - Member ITC Hotel Group </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About Fortune Select JP Cosmos - Member ITC Hotel Group</h1>
