...
<?php
$cookie_name="hotel";
$cookie_value="ITC_Maratha_A_Luxury_Collection_Hotel";
...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="Itc.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Itc22.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Itc33.webp" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
      </div>
      <div class="buttons">
        <a href="#slide-1"></a>
        <a href="#slide-2"></a>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.0827951434653!2d72.86744891744384!3d19.104023400000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c8412eabd40d%3A0x24090700409101ee!2sITC%20Maratha%2C%20a%20Luxury%20Collection%20Hotel%2C%20Mumbai!5e0!3m2!1sen!2sin!4v1666185090970!5m2!1sen!2sin" width="650" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">ITC Maratha - A Luxury Collection Hotel </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About ITC Maratha - A Luxury Collection Hotel</h1>
<p class="card-text" style="font-weight:bold; font-size:20px; font-style:italic;">Close to Mumbai International Airport, this premium property features comfortable rooms, multiple dining options, a full-service spa and a host of upscale amenities.</p>
