...
<?php
$cookie_name="hotel";
$cookie_value="Collection_O_30004_Malleswaram";
...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="Malleswaram.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Malleswaram2.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Malleswaram3.webp" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
      </div>
      <div class="buttons">
        <a href="#slide-1"></a>
        <a href="#slide-2"></a>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.6503386983654!2d77.57033531434571!3d12.994201990841038!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae162363ea9cf7%3A0xcdadb8d46b0d2fe7!2sCollection%20O%2030004%20Malleswaram!5e0!3m2!1sen!2sin!4v1666177057177!5m2!1sen!2sin" width="650" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">Collection O 30004 Malleswaram </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About Collection O 30004 Malleswaram</h1>
