...
<?php
$cookie_name="hotel";
$cookie_value="Hotel_Gemini_Continental";
...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="Gemini.webp" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Gemini2.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Gemini3.jpg" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
      </div>
      <div class="buttons">
        <a href="#slide-1"></a>
        <a href="#slide-2"></a>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.6028282459415!2d80.93413621460734!3d26.852582083153507!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfe6285338355%3A0xde8d40ccec8cd69f!2sGemini%20Continental!5e0!3m2!1sen!2sin!4v1666164411242!5m2!1sen!2sin" width="650" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">Hotel Gemini Continental </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About Hotel Gemini Continental</h1>
<p class="card-text" style="font-weight:bold; font-size:20px; font-style:italic;">Close to Lucknow International Airport, this premium property features comfortable rooms, multiple dining options, a full-service spa and a host of upscale amenities.</p>
