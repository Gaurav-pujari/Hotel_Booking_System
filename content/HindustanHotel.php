...
<?php
$cookie_name="hotel";
$cookie_value="The_Hotel_Hindustan_International";
...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="Hindustan.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Hindustan2.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Hindustan3.jpg" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.290767806235!2d73.91246941442974!3d18.560925387385478!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c17295f8e7d1%3A0x54a09bca8d6d8ce2!2sHotel%20Hindusthan%20International!5e0!3m2!1sen!2sin!4v1663496833015!5m2!1sen!2sin" width="650" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">THE HOTEL HINDUSTAN INTERNATIONAL </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About The Hotel Hindustan International</h1>
<p class="card-text" style="font-weight:bold; font-size:20px; font-style:italic;">Close to Pune International Airport, this premium property features comfortable rooms, multiple dining options, a full-service spa and a host of upscale amenities.</p>
