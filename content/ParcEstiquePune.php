...
<div  class="container0">
    ...
    <div class="card0">
      ...
      <div class="image-container">
        <img src="ParcEstiquePune.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Parc2.jpg" class="slide" width="800px" height="500px" style=" border-radius:12px;"/>
        <img src="Parc6.jpg" class="slide" width="800px" height="500px"style=" border-radius:12px;" />
      </div>
      <div class="buttons">
        <a href="#slide-1"></a>
        <a href="#slide-2"></a>
...
<div class="card1"style="background-color:#eeeeee;color:black;background-image: url('back.webp');">
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.2659147136787!2d73.91743691472138!3d18.562046587384852!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c143ca810321%3A0x7e55b334dc6bbc25!2sHotel%20Parc%20Estique!5e0!3m2!1sen!2sin!4v1661671927701!5m2!1sen!2sin" width="650px" height="300px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
 <center> <h2 class="card-title" style="font-style:italic;">LOCATION</h2></center>
  </div>
    </div>
 <h1 class="card-title" style="font-style:italic; margin-left:30px;">HOTEL PARC ESTIQUE </h1>
...
<div class="myDiv">
<div class="overview">
  <h1 class="card-title" style="font-style:italic;">About Hotel Parc Estique</h1>
